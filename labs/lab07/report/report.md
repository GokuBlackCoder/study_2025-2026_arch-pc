...
![Создание каталога и файла для программы](images/1.png){#fig:001 width=70%}

Копирую код из листинга в файл будущей программы. (рис. -@fig:002).

![Сохранение программы](images/2.png){#fig:002 width=70%}
...
![Проверка программы из листинга](images/9.png){#fig:009 width=70%}
...
![Проверка файла листинга](images/10.png){#fig:010 width=70%}
...
![Удаление операнда из программы](images/11.png){#fig:011 width=70%}
...
![Просмотр ошибки в файле листинга](images/12.png){#fig:012 width=70%}
...
![Первая программа самостоятельной работы](images/13.png){#fig:013 width=70%}
...
![Проверка работы первой программы](images/14.png){#fig:014 width=70%}
...
![Вторая программа самостоятельной работы](images/15.png){#fig:015 width=70%}
...
![Проверка работы второй программы](images/16.png){#fig:016 width=70%}
